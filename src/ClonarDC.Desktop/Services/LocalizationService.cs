...
public static class LocalizationService
{
    ...
    private static Dictionary<string, string> Portuguese() => new(StringComparer.Ordinal)
    {
        ...
        ["Sign in"] = "Entrar", ["Access your GuildSync account"] = "Acesse sua conta GuildSync",
        ...
        ["Quick control of your GuildSync environment."] = "Controle rápido do seu ambiente GuildSync.",
    ...
    private static Dictionary<string, string> Spanish() => new(StringComparer.Ordinal)
    {
        ...
        ["Sign in"] = "Iniciar sesión", ["Access your GuildSync account"] = "Accede a tu cuenta de GuildSync", ["Email"] = "Correo electrónico", ["Password"] = "Contraseña", ["Create account"] = "Crear cuenta",
        ...
        ["Quick control of your GuildSync environment."] = "Control rápido de tu entorno GuildSync.", ["Local backups"] = "Copias locales", ["Last operation"] = "Última operación", ["None in this session"] = "Ninguna en esta sesión", ["Safe workflow"] = "Flujo seguro",
    ...
    {
        ["Server structures, organized with precision."] = "Structures de serveurs, organisées avec précision.", ["Sign in"] = "Se connecter", ["Access your GuildSync account"] = "Accédez à votre compte GuildSync", ["Email"] = "E-mail", ["Password"] = "Mot de passe", ["Create account"] = "Créer un compte",
        ...
        ["Overview"] = "Vue d’ensemble", ["Cloning"] = "Clonage", ["Backups"] = "Sauvegardes", ["Operations"] = "Opérations", ["License"] = "Licence", ["Settings"] = "Paramètres", ["Administration"] = "Administration", ["Sign out"] = "Se déconnecter", ["Quick control of your GuildSync environment."] = "Contrôle rapide de votre environnement GuildSync.", ["Local backups"] = "Sauvegardes locales", ["Last operation"] = "Dernière opération", ["None in this session"] = "Aucune dans cette session", ["Safe workflow"] = "Flux sécurisé",
