        ...
        string botApiKey)
    {
        ...
        app.MapGet("/discord/link/status", async (HttpContext context) =>
        {
            ...
            return Results.Ok(link is null
                ...
                : new { linked = true, discordUserId = link.DiscordUserId, linkedAt = (DateTimeOffset?)link.LinkedAt });
        });
...
sealed partial class JsonStore
{
    ...
    public async Task<DiscordAccountLinkRecord?> GetDiscordLinkByUserAsync(string userId)
    {
        ...
        try
        {
            ...
            return link is null ? null : Clone(link);
        }
        finally
        {
            _gate.Release();
    ...
    public async Task<DiscordLinkedAccount?> GetDiscordLinkedAccountAsync(string discordUserId)
    {
        ...
        try
        {
            ...
            return user is null ? null : new DiscordLinkedAccount(CloneUser(user), Clone(link));
        }
        finally
        {
            _gate.Release();
    ...
    private static DiscordAccountLinkRecord Clone(DiscordAccountLinkRecord link) =>
